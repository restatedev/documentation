...
If you use the `/send` endpoint to invoke a [workflow](/concepts/services#workflows) or handler, then the invocation runs in the background.

Restate allows you to latch onto the ongoing invocation.
