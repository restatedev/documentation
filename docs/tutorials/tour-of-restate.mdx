...
```shell
docker run --name restate_dev --rm -d -e RESTATE_OBSERVABILITY__JAEGER__ENDPOINT=localhost:6831 --network=host ghcr.io/restatedev/restate-dist:0.1.1
```
...
```shell
docker run --name restate_dev --rm -d -e RESTATE_OBSERVABILITY__JAEGER__ENDPOINT=localhost:6831 -p 8081:8081 -p 9091:9091 -p 9090:9090 ghcr.io/restatedev/restate-dist:0.1.1
```
