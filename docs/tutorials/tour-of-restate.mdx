...
If you do a side effect operation in your handler and the side effect fails,
...
:::info Bugs?
🚩 Have a look at the fully implemented app in `src/part4`, and run it with `npm run part4`.
:::
