...
Clone the GitHub repository of the [tutorial](https://github.com/restatedev/tour-of-restate-typescript/tree/v0.0.1):
```shell
git clone --depth 1 --branch v0.0.1 git@github.com:restatedev/tour-of-restate-typescript.git
```
