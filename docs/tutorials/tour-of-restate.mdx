...
```shell
docker run --name restate_dev -e RUST_LOG=info,restate=info --network=host ghcr.io/restatedev/restate-dist:latest
```
...
```shell
docker run --name restate_dev -e RUST_LOG=info,restate=info -p 8081:8081 -p 9091:9091 -p 9090:9090 ghcr.io/restatedev/restate-dist
```
...
```shell
docker run --name restate_dev -e RESTATE_OBSERVABILITY__JAEGER__ENDPOINT=localhost:6831 -e RUST_LOG=info,restate=info --network=host ghcr.io/restatedev/restate-dist:latest
```
...
```shell
docker run --name restate_dev -e RESTATE_OBSERVABILITY__JAEGER__ENDPOINT=localhost:6831 -e RUST_LOG=info,restate=info -p 8081:8081 -p 9091:9091 -p 9090:9090 ghcr.io/restatedev/restate-dist
```
