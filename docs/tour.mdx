...
:::tip Good news!
Restate retries failed one-way invocations for you. No need to set up message queues. You can provide additional configuration for the retry settings as an optional argument to all the RPC methods.
:::
