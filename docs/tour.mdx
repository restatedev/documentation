...
The simplest way to make a call within Restate is to use `ctx.call` with a method reference and a request. Use `.await()` to wait for the response to the call.

Try it out by running the services via `./gradlew run` and send a request to `example.UserSession/AddTicket`, as we did [previously](#running-the-services-and-runtime).
...
Update `expireTicket` to use `ctx.oneWayCall` to send a one-way message to release the reservation:
...
Note that `oneWayCall` isn't an asynchronous operation in the Restate SDK, so there is no need to call `await()` on it.

Once you have adapted the code, restart the service and try it out by calling the `UserSession.expireTicket` method as [explained earlier](#running-the-services-and-runtime). In the service logs, you will see that the `addTicket` method doesn't wait for a response and completes before `reserve` does. The external call will get a response much quicker in this scenario.

<details><summary>Show the logs</summary>

```log
//highlight-next-line
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.UserSession/ExpireTicket
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.UserSession/ExpireTicket
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=WAITING_START, id=jRn_FAzvp8UAYxJ02UPd7qxFarQ6_-N-A) to REPLAYING
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=REPLAYING, id=jRn_FAzvp8UAYxJ02UPd7qxFarQ6_-N-A) to PROCESSING
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=PROCESSING, id=jRn_FAzvp8UAYxJ02UPd7qxFarQ6_-N-A) to CLOSED
//highlight-next-line
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
//highlight-next-line
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.TicketService/Unreserve
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.TicketService/Unreserve
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=WAITING_START, id=IwF2v7ci3eUAYxJ02XJfCW5xj_UK5P0Mg) to REPLAYING
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=REPLAYING, id=IwF2v7ci3eUAYxJ02XJfCW5xj_UK5P0Mg) to PROCESSING
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=PROCESSING, id=IwF2v7ci3eUAYxJ02XJfCW5xj_UK5P0Mg) to CLOSED
//highlight-next-line
2023-12-08 16:27:20 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
```
...
```log
2023-12-08 17:35:22 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.TicketService/Reserve
2023-12-08 17:35:22 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.TicketService/Reserve
2023-12-08 17:35:22 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=WAITING_START, id=jRn_FAzvp8UAYxKEbE1cN-UN_QKAIeDcw) to REPLAYING
2023-12-08 17:35:22 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=REPLAYING, id=jRn_FAzvp8UAYxKEbE1cN-UN_QKAIeDcw) to PROCESSING
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=PROCESSING, id=IwF2v7ci3eUAYxJ97Rwc-eEsktFA34P8g) to CLOSED
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.UserSession/AddTicket
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.UserSession/AddTicket
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=WAITING_START, id=jRn_FAzvp8UAYxJ97RhfXuMe3GpnRmgjQ) to REPLAYING
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=REPLAYING, id=jRn_FAzvp8UAYxJ97RhfXuMe3GpnRmgjQ) to PROCESSING
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=PROCESSING, id=jRn_FAzvp8UAYxJ97RhfXuMe3GpnRmgjQ) to CLOSED
2023-12-08 17:35:47 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
2023-12-08 17:35:57 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=PROCESSING, id=jRn_FAzvp8UAYxKEbE1cN-UN_QKAIeDcw) to CLOSED
2023-12-08 17:35:57 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
```
...
```log
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.UserSession/AddTicket
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.UserSession/AddTicket
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=WAITING_START, id=K1qex52CPYkAYxKIRMsc5q67M472_jBDA) to REPLAYING
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=REPLAYING, id=K1qex52CPYkAYxKIRMsc5q67M472_jBDA) to PROCESSING
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.TicketService/Reserve
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.TicketService/Reserve
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=WAITING_START, id=IwF2v7ci3eUAYxKIRNJd-2KnRSQvG3w_Q) to REPLAYING
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=REPLAYING, id=IwF2v7ci3eUAYxKIRNJd-2KnRSQvG3w_Q) to PROCESSING
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.TicketService', state=PROCESSING, id=IwF2v7ci3eUAYxKIRNJd-2KnRSQvG3w_Q) to CLOSED
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:665 - Transitioning InvocationStateMachine(serviceName='example.UserSession', state=PROCESSING, id=K1qex52CPYkAYxKIRMsc5q67M472_jBDA) to CLOSED
2023-12-08 17:52:10 [vert.x-eventloop-thread-0] DEBUG InvocationStateMachine:206 - Closing state machine
```
