...
<details>
    ...
    <Tabs groupId="sdk" queryString>
        ...
        <TabItem value="java" label="Java">
            ...
            ```java
            CODE_LOAD::java/src/main/java/concepts/components/Components.java#<start_call_service>-<end_call_service>
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="java" label="Java">
        ...
        ```java
        CODE_LOAD::java/src/main/java/concepts/components/Components.java#<start_call_virtual_object>-<end_call_virtual_object>
        ```
