...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        ...
        <CH.Scrollycoding className={"spotlight-long-code"}>
            ...
            CODE_LOAD::ts/src/concepts/services.ts#service
            ```
...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        <CH.Scrollycoding className={"spotlight-long-code"}>
            ...
            CODE_LOAD::ts/src/concepts/virtual_objects.ts#virtual_object
            ```
...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        <CH.Scrollycoding className={"spotlight-long-code"}>
            ...
            CODE_LOAD::ts/src/concepts/workflow.ts#workflow
            ```
    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className={"spotlight-long-code"}>
            ...
            ```java mark=8:28
            CODE_LOAD::java/src/main/java/concepts/services/Payment.java#workflow
            ```
