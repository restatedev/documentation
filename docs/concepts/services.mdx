...
A workflow is a special type of Virtual Object.
...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        ...
        <CH.Spotlight className={"spotlight-long-code"}>
            ...
            These handlers are able to run concurrently to the `run` handler.
            ...
            You can **signal the workflow**, to send information to it.
