...
For more information on how to deploy the Restate Server, have a look at the [deployment documentation](/deploy/overview).
To learn more about Restate's architecture, have a look at the [architecture documentation](/concepts/architecture) and [the deep-dive architecture blog post](https://restate.dev/blog/the-anatomy-of-a-durable-execution-stack-from-first-principles/).

The main feature the Restate Server provides is [Durable Execution](/concepts/durable_execution).
