...
For primitive types, you can do this by using Restate's built-in `dev.restate.sdk.core.CoreSerdes`.
For other types, have a look at the [serialization documentation](/develop/sdk/serialization).

</TabItem>
</Tabs>

You can also reject an awakeable, that is completing it with a failure. This will cause the waiting service to throw [a terminal error](/develop/sdk/error-handling):
