...
:::tip
To get started, check out [the Java template project](https://github.com/restatedev/examples/tree/main/templates/java-gradle).
:::
...
```typescript
CODE_LOAD::ts/src/overview_handler.ts
```
...
```java
CODE_LOAD::java/src/main/java/Greeter.java
```
