...
An event handlers can profit from the same features as other Restate handlers, including durable execution, [service communication](/develop/sdk/service-communication) and [side effects](/develop/sdk/side-effects).
