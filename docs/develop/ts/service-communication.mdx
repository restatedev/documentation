...
Make sure you export the service definition of the service you want to call, as we did in the [service example on the overview page](/develop/ts/overview#service):
...
<Admonition type={"caution"} title={"Deadlocks with Virtual Objects"}>
    ...
    In this situation you'll have to unblock the Virtual Object manually by [cancelling invocations](/operate/invocation#cancel-an-invocation). Some example cases:
