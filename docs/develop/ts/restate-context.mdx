...
<Admonition type="tip" icon="💡" title="Use the Restate Context to benefit from Durable Execution">
...
Be aware that if you do actions (e.g. calling other services, sleep) without making use of the Restate SDK,
