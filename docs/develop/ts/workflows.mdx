...
<CH.Spotlight className={"spotlight-medium"}>
    ...
    [**Submit**](/invoke/clients#invoking-handlers-with-the-sdk-clients):
    This returns when the workflow has been registered in Restate.
...
<CH.Spotlight className={"spotlight-medium"}>
    [**Query/signal**](/invoke/clients#invoking-handlers-with-the-sdk-clients):
...
<CH.Spotlight className={"spotlight-medium"}>
    ...
    [**Attach**](/invoke/http#retrieve-result-of-invocations-and-workflows):
    This lets you retrieve the result of a workflow later.
