...
Note that the extension will start one Restate server for the whole test class. For more details, checkout [`RestateTest` Javadocs](/javadocs/dev/restate/sdk/testing/RestateRunner.html).
