...
<TabItem value="java" label="Java">
    <CH.Section>
        ...
        - [The `WorkflowContext` and `SharedWorkflowContext` give access to some additional features](focus://5,13): [workflow K/V state](/develop/java/state), and [Durable Promises](/develop/java/workflow_signals). Have a look at their respective docs to learn more.
