...
<Tabs groupId="sdk" queryString>
    <TabItem value="java" label="Java">
        <CH.Section>
            ...
            2. [Bind one or multiple services to it](focus://6:8)
            3. [Listen on the specified port (default `9080`) for connections and requests.](focus://9)
...
<TabItem value="kotlin" label="Kotlin">
    <CH.Section>
        ...
        2. [Bind one or multiple services to it](focus://5:7)
