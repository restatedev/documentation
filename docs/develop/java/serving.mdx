...
<Tabs groupId="sdk" queryString>
    <TabItem value="java" label="Java">
        ...
        <CH.Section>
            ...
            2. [Bind one or multiple services to it](focus://6)
...
<TabItem value="kotlin" label="Kotlin">
    <CH.Section>
        ...
        1. [Create a `RestateHttpEndpointBuilder`](focus://2)
        2. [Bind one or multiple services to it](focus://3)
        3. [Listen on the specified port (default `9080`) for connections and requests.](focus://4)
...
<CH.Section>
    ...
    3. [Override the register method](focus://5:6,8)
    4. [Bind one or multiple services to the builder](focus://7)
...
<TabItem value="kotlin" label="Kotlin">
    ...
    1. Add the dependency `dev.restate:sdk-lambda:VAR::JAVA_SDK_VERSION`.
    2. [Extend the class `BaseRestateLambdaHandler`](focus://4)
    3. [Override the register method](focus://5,7)
    4. [Bind one or multiple services to the builder](focus://6)
    </CH.Section>
</TabItem>
</Tabs>
