...
```java
CODE_LOAD::java/src/main/java/develop/SideEffects.java#side_effect
```
...
```kotlin
CODE_LOAD::kotlin/src/main/kotlin/develop/SideEffects.kt#side_effect
```
...
<TabItem value="java" label="Java">
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        **Await all** creates an `Awaitable` that awaits for all of the provided Awaitables to resolve.
        ...
        ```java
        CODE_LOAD::java/src/main/java/develop/SideEffects.java#combine_all
        ```
    </CH.Scrollycoding>
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        **Await any** creates an `Awaitable` that awaits any of the provided Awaitables to resolve.
        ...
        ```java
        CODE_LOAD::java/src/main/java/develop/SideEffects.java#combine_any
        ```
    </CH.Scrollycoding>
</TabItem>
<TabItem value="kotlin" label="Kotlin">
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ...
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/SideEffects.kt#combine_all
        ```
    </CH.Scrollycoding>
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ### Await any
        ...
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/SideEffects.kt#combine_any
        ```
    </CH.Scrollycoding>
...
<TabItem value="java" label="Java">
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ...
        ```java
        CODE_LOAD::java/src/main/java/develop/SideEffects.java#uuid
        ```
    ...
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ...
        ```java
        CODE_LOAD::java/src/main/java/develop/SideEffects.java#random_nb
        ```
...
<TabItem value="kotlin" label="Kotlin">
    ...
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ...
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/SideEffects.kt#uuid
        ```
    ...
    <CH.Scrollycoding className={clsx("single-item", "durable-promises-short")}>
        ...
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/SideEffects.kt#random_nb
        ```
