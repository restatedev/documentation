...
This means that non-deterministic code (e.g. database responses, UUID generation), needs to be stored in the execution log.
...
You can use this to generate stable idempotency keys, to deduplicate operations.
