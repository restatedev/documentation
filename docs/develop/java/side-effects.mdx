...
2. **[Promise/awaitable combinators](/develop/java/side-effects#promiseawaitable-combinators)**: Log the order in which promises were resolved/rejected, to ensure deterministic replay.
3. **[Random generators](/develop/java/side-effects#generating-randoms)**: Built-in helpers for generating stable UUIDs and random numbers.
