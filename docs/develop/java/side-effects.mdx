...
2. **[`Awaitable` combinators](/develop/java/side-effects#awaitable-combinators)**: Log the order in which Awaitables were resolved/rejected, to ensure deterministic replay.
