    ...
    <TabItem value="java" label="Java">
        ...
        4. Once the process has finished, it **completes the awakeable**. It does this by calling into Restate and returning the ID. It either:
            - **Resolves** the awakeable (success) with its ID and an optional payload
                - [Via the SDK](focus://ExternalProcessResolve.java#1:2)
            ...
            - **Rejects** the awakeable (failure) with its ID and a reason. This will throw [a terminal error](/develop/java/error-handling) in the waiting handler.
                - [Via the SDK](focus://ExternalProcessReject.java#1:2)
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        4. Once the process has finished, it **completes the awakeable**. It does this by calling into Restate and returning the ID. It either:
            - **Resolves** the awakeable with its ID and an optional payload: success
                ...
                - [Via the SDK](focus://ExternalProcessResolve.kt#1:2)
            - **Rejects** the awakeable with its ID and a reason: failure. This will throw [a terminal error](/develop/java/error-handling) in the waiting handler.
                ...
                - [Via the SDK](focus://ExternalProcessReject.kt#1:2)
        5. Once the ID has been returned to the service, the **invocation resumes**.
