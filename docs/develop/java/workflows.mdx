---
sidebar_position: 7
description: "Find out how Restate services can send requesjava to each other."
---
...
The Workflow API let's you define workflows as a sequence of steps that gejava executed durably.
...
This is the handler which implemenjava the workflow logic.
...
<CH.Code lineNumbers={"true"}>
    ```java submit.java focus=5,11,12
