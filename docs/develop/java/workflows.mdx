...
Look at the [HTTP](/http#retrieve-result-of-invocations-and-workflows) and [client invocation docs](/invoke/clients?sdk=java#retrieve-result-of-invocations-and-workflows) for more details.
