    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className={"single-item"}>
            ...
            **Request-response invocations** allow you to wait on a response from the handler.
            ...
            ```java
            CODE_LOAD::java/src/main/java/develop/clients/Ingress.java#<start_rpc_java>-<end_rpc_java>
            ```
        ...
        <CH.Scrollycoding className={"single-item"}>
            ...
            **One-way invocations** allow you to send a message without waiting for a response.
            ...
            ```java
            CODE_LOAD::java/src/main/java/develop/clients/Ingress.java#<start_one_way_call_java>-<end_one_way_call_java>
            ```
        ...
        <CH.Scrollycoding className={"single-item"}>
            ...
            **Delayed invocations** allow you to schedule an invocation for a later point in time.
            ...
            ```java
            CODE_LOAD::java/src/main/java/develop/clients/Ingress.java#<start_delayed_call_java>-<end_delayed_call_java>
            ```
        ...
        <TabItem value="kotlin" label="Kotlin">
            <CH.Scrollycoding className={"single-item"}>
                ...
                **Request-response invocations** allow you to wait on a response from the handler.
                ...
                ```kotlin
                CODE_LOAD::kotlin/src/main/kotlin/develop/clients/Ingress.kt#<start_rpc_kotlin>-<end_rpc_kotlin>
                ```
            ...
            <CH.Scrollycoding className={"single-item"}>
                ...
                **One-way invocations** allow you to send a message without waiting for a response.
                ...
                ```kotlin
                CODE_LOAD::kotlin/src/main/kotlin/develop/clients/Ingress.kt#<start_one_way_call_kotlin>-<end_one_way_call_kotlin>
                ```
            ...
            <CH.Scrollycoding className={"single-item"}>
                ...
                **Delayed invocations** allow you to schedule an invocation for a later point in time.
                ...
                ```kotlin
                CODE_LOAD::kotlin/src/main/kotlin/develop/clients/Ingress.kt#<start_delayed_call_kotlin>-<end_delayed_call_kotlin>
                ```
...
<Tabs groupId="sdk" queryString>
    <TabItem value="java" label="Java">
        ```java
        CODE_LOAD::java/src/main/java/develop/clients/Ingress.java#<start_service_idempotent>-<end_service_idempotent>
        ```
    </TabItem>
    <TabItem value="kotlin" label="Kotlin">
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/clients/Ingress.kt#<start_service_idempotent>-<end_service_idempotent>
        ```
    </TabItem>
</Tabs>
...
<Tabs groupId="sdk" queryString>
    <TabItem value="java" label="Java">
        ```java
        CODE_LOAD::java/src/main/java/develop/clients/Ingress.java#<start_service_attach>-<end_service_attach>
        ```
    </TabItem>
    <TabItem value="kotlin" label="Kotlin">
        ```kotlin
        CODE_LOAD::kotlin/src/main/kotlin/develop/clients/Ingress.kt#<start_service_attach>-<end_service_attach>
        ```
    </TabItem>
</Tabs>
