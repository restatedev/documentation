...
To schedule a handler to be called at a later time, have a look at the documentation on [delayed calls](/develop/java/service-communication#delayed-calls).
...
```java
CODE_LOAD::java/src/main/java/develop/DurableTimers.java#<start_sleep>-<end_sleep>
```
...
```kotlin
CODE_LOAD::kotlin/src/main/kotlin/develop/DurableTimers.kt#<start_sleep>-<end_sleep>
```
