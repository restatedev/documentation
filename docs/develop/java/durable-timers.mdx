...
<Admonition type="caution">
Don't use the language's own timer implementations or sleep functions in combination with Restate. Otherwise, you do not benefit from resilience or suspensions.
</Admonition>
