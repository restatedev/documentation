...
- `RESTATE_ADMIN_URL`: To specify the full URL of meta service (scheme+host+port).
...
For example, to connect to the Restate Admin URL `http://myhost:7777`, save the following in a `.env` file:

```
RESTATE_ADMIN_URL=http://myhost:7777
```
