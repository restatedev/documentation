...
<CH.Scrollycoding className="workflows-scroller">
    ...
    ```ts role_updater.ts
    CODE_LOAD::ts/src/use_cases/role_updater.ts?1
    ```
    ...
    ```ts role_updater.ts
    CODE_LOAD::ts/src/use_cases/role_updater.ts?2
    ```
    ...
    ```ts role_updater.ts
    CODE_LOAD::ts/src/use_cases/role_updater.ts?3
    ```
    ...
    ```ts role_updater.ts
    CODE_LOAD::ts/src/use_cases/role_updater.ts?4
    ```
...
<TabItem value="java" label="Java">
    ...
    CODE_LOAD::java/src/main/java/use_cases/microservices/RoleUpdateService.java?1
    ```
    ...
    ```java RoleUpdateService.java
    CODE_LOAD::java/src/main/java/use_cases/microservices/RoleUpdateService.java?2
    ```
    ...
    ```java RoleUpdateService.java
    CODE_LOAD::java/src/main/java/use_cases/microservices/RoleUpdateService.java?3
    ```
    ...
    ```java RoleUpdateService.java
    CODE_LOAD::java/src/main/java/use_cases/microservices/RoleUpdateService.java?4
    ```
...
<CH.Scrollycoding>
    ...
    CODE_LOAD::java/src/main/java/use_cases/microservices/Idempotency.java?1
    ```
