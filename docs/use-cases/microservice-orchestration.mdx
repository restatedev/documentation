...
## Durable Communication & Idempotency
...
Restate guarantees code runs to completion. This makes it easy to implement resilient [sagas](https://www.baeldung.com/cs/saga-pattern-microservices) in a simple try-catch block.
