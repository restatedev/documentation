...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="kotlin" label={"Kotlin"}>
        <CH.Scrollycoding className="workflows-scroller">
            ...
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?1
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?2
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?3
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?4
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?5
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?6
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/SignupWorkflow.kt?7
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value={"kotlin"} label={"Kotlin"}>
        <CH.Scrollycoding className={clsx("single-item", "durable-promises")}>
            ...
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/workflows/WorkflowSubmitter.kt
            ```
