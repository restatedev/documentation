...
<div className={"row"}>
    ...
    <div className={"col col--6"}>
        <img src={"/img/use_cases/use-case-workflows-light.svg"} alt={"Workflows-as-code"}/>
    </div>
</div>
...
<ExampleWidget features={[
    {
        ...
        links: [{ url: "https://github.com/restatedev/examples/blob/main/basics/basics-typescript/src/3_workflows.ts", icon: "/img/typescript.svg"}]
    },
    {
    ...
    },
    {
        ...
        links: [{ url: "https://github.com/restatedev/examples/tree/main/end-to-end-applications/typescript/ai-image-workflows", icon: "/img/typescript.svg"}]
    },
    {
