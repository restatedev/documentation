...
<p className={"use-case-description padding-bottom--lg text--left"}>Combine the resiliency of workflows with the speed and flexibility of regular functions.<br/>
...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        <CH.Scrollycoding className="workflows-scroller">
            ...
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?1
            ```
            ...
            ```ts user_sign_up_flow.ts
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?2
            ```
            ...
            ```ts user_sign_up_flow.ts
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?3
            ```
            ...
            ```ts user_sign_up_flow.ts
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?4
            ```
            ...
            ```ts user_sign_up_flow.ts
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?6
            ```
            ...
            ```ts user_sign_up_flow.ts
            CODE_LOAD::ts/src/use_cases/signup_workflow.ts?7
            ```
    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className="workflows-scroller">
            ...
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?1
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?2
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?3
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?4
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?5
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?6
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/workflows/SignupWorkflow.java?7
            ```
    ...
    <TabItem value="kotlin" label={"Kotlin"}>
        <CH.Scrollycoding className="workflows-scroller">
            ...
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?1
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?2
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?3
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?4
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?5
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?6
            ```
            ...
            ```kotlin SignupWorkflow.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/SignupWorkflow.kt?7
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className={clsx("single-item", "durable-promises")}>
            ...
            CODE_LOAD::java/src/main/java/use_cases/workflows/WorkflowSubmitter.java
            ```
        </CH.Scrollycoding>
    </TabItem>
    <TabItem value={"kotlin"} label={"Kotlin"}>
        <CH.Scrollycoding className={clsx("single-item", "durable-promises")}>
            ...
            ```kotlin WorkflowSubmitter.kt
            CODE_LOAD::kotlin/src/main/kotlin/use_cases/WorkflowSubmitter.kt
            ```
