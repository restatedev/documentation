...
<CH.Scrollycoding className="workflows-scroller">
    ...
    ```ts user_sign_up_flow.ts focus=1:4,24,44:45 mark=1:4,24,44,45
    ...
    <CH.Code>
        ```ts user_sign_up_flow.ts focus=1:4,24,44:45,8,11,12 mark=8,11,12
        CODE_LOAD::ts/src/use_cases/signup_workflow.ts
        ```
    </CH.Code>
    ...
    ```ts user_sign_up_flow.ts focus=1:4,24,44:45,8,11,12,7,10,20,23 mark=7,10,20,23
    CODE_LOAD::ts/src/use_cases/signup_workflow.ts
    ```
    ...
    ```ts user_sign_up_flow.ts focus=1:4,24,44:45,8,11,12,7,10,20,23,27:29 mark=27:29
    CODE_LOAD::ts/src/use_cases/signup_workflow.ts
    ```
    ...
    ```ts user_sign_up_flow.ts focus=1:4,24,44:45,8,11,12,7,10,20,23,26:28,15 mark=15
    CODE_LOAD::ts/src/use_cases/signup_workflow.ts
    ```
    ...
    ```ts user_sign_up_flow.ts focus=1:4,24,44:45,8,11,12,7,10,20,23,26:28,15,31:44 mark=31:44
    CODE_LOAD::ts/src/use_cases/signup_workflow.ts
    ```
