...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className="workflows-scroller">
            ...
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?1
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?2
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?3
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?4
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?5
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?6
            ```
            ...
            ```java SignupWorkflow.java
            CODE_LOAD::java/src/main/java/use_cases/SignupWorkflow.java?7
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="java" label="Java">
        <CH.Scrollycoding className={clsx("single-item", "durable-promises")}>
            ...
            CODE_LOAD::java/src/main/java/use_cases/WorkflowSubmitter.java
            ```
        </CH.Scrollycoding>
    </TabItem>
    <TabItem value={"kotlin"} label={"Kotlin"}>
