...
<ExampleWidget features={[
    {
        ...
        links: [
            ...
            { url: "https://github.com/restatedev/examples/blob/main/java/workflows/SignupWorkflow.java", icon: "/img/java.svg"},
            { url: "https://github.com/restatedev/examples/blob/main/kotlin/workflows/SignupWorkflow.kt", icon: "/img/kotlin.svg"},
