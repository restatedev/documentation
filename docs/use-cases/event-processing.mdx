...
<FeatureList className={"padding-bottom--lg"} features={[
    ...
    {
        title: 'Parallelize complex, long-running workflows',
...
<SpotlightCard>
    <TwoColumnText features={[
        {
            title: 'LOW-LATENCY',
            description: <>Restate’s event-driven foundation lets you process events at high speed. Restate keeps a queue per key and pushes events to your functions to process them in parallel as fast as possible. <br/><br/>  <a href={"https://restate.dev/blog/the-anatomy-of-a-durable-execution-stack-from-first-principles/#some-performance-numbers"}>Learn more</a></>,
        },
        {
...
<ExampleWidget itemsPerRow={3} features={[
    {
        title: 'Agents, actors and digital twins',
    ...
    {
        title: 'Transactional event processing or workflows over Kafka',
        description: "Execute a flow of steps with retries and recovery.",
        links: [
    ...
    {
        title: 'Flexible control flow and scheduling of events',
        description: "Scheduling reminders in a loop until another function has been called.",
        links: [
