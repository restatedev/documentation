...
<div className={"row"}>
    <div className={"col col--6 col-lg-6 col-md-12 "}>
        ...
        <p className={"use-case-description padding-bottom--lg text--left"}>
            Restate lets you write resilient scheduling logic with the flexibility of code: delay execution, re-attach to ongoing tasks, fan-out/in patterns, and more.
            Restate guarantees that your tasks run to completion exactly once.
        </p>
    </div>
    <div className={"col col--6 col-lg-6 col-md-12"}>
...
<FeatureList className={"padding-bottom--lg"} features={[
    {
        ...
        description: "Persist timers in Restate. Restate makes sure that they get fired when they should, whether it's millis or months later.",
    },
    {
        title: '(Delayed) task queue',
        iconPath: '/img/use_cases/queue.svg',
        description: "Use Restate as message queue and schedule tasks asynchronously. Tasks execute with workflow-like durability and reliability. Restate handles retries and recovery of progress."
    },
    {
        title: 'Switch between async and sync',
        iconPath: '/img/use_cases/switch.svg',
        description: "Schedule an async task through Restate, then let any process latch onto it later to wait for the result or check its completion status, all with built-in durability.",
    },
]}/>
...
<Scrollycoding>
    ...
    Any function becomes a durable async task by using Restate as your message queue.
    Restate persists all requests and ensures they run to completion with automatic retries and recovery upon failures.
    ...
    ```kotlin !!tabs Kotlin https://github.com/restatedev/examples/blob/main/kotlin/patterns-use-cases/src/main/kotlin/my/example/queue/AsyncTaskService.kt
    CODE_LOAD::kotlin/src/main/kotlin/usecases/asynctasks/simple/AsyncTaskService.kt?1
    ```
    ```kotlin !!tabs Kotlin https://github.com/restatedev/examples/blob/main/kotlin/patterns-use-cases/src/main/kotlin/my/example/queue/TaskSubmitter.kt
    ...
    CODE_LOAD::go/usecases/asynctasks/simpleasynctask/client/tasksubmitter.go
    ```
    ...
    ```kotlin !!tabs Kotlin https://github.com/restatedev/examples/blob/main/kotlin/patterns-use-cases/src/main/kotlin/my/example/queue/AsyncTaskService.kt
    CODE_LOAD::kotlin/src/main/kotlin/usecases/asynctasks/simple/AsyncTaskService.kt
    ```
    ```kotlin !!tabs Kotlin https://github.com/restatedev/examples/blob/main/kotlin/patterns-use-cases/src/main/kotlin/my/example/queue/TaskSubmitter.kt
    ...
    ```go !!tabs Go https://github.com/restatedev/examples/blob/main/go/patterns-use-cases/src/queue/service/asynctaskworker.go
    CODE_LOAD::go/usecases/asynctasks/simpleasynctask/asynctaskworker.go
    ```
    ```go !!tabs Go https://github.com/restatedev/examples/blob/main/go/patterns-use-cases/src/queue/client/tasksubmitter.go
...
<Scrollycoding>
    ...
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/src/parallelizework/app.py
    CODE_LOAD::python/src/use_cases/async_tasks/app.py?1
    ```
    ...
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/src/parallelizework/app.py
    CODE_LOAD::python/src/use_cases/async_tasks/app.py?2
    ```
    ...
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/src/parallelizework/app.py
    CODE_LOAD::python/src/use_cases/async_tasks/app.py?3
    ```
...
<SpotlightCard>
    <TwoColumnText features={[
        {
            title: 'LOW-LATENCY',
            description: <>Restate’s event-driven foundation built in Rust lets you queue events. Restate pushes them to your functions at high speed.<br/><br/>  <a href={"https://restate.dev/blog/the-anatomy-of-a-durable-execution-stack-from-first-principles/#some-performance-numbers"}>Learn more</a></>,
        },
        {
...
<Scrollycoding>
    ...
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/src/schedulingtasks/payment_tracker.py
...
<FeatureWidget features={[
    {
        title: 'Docs: Invocations and Scheduling',
        links: [
            {url: "/concepts/invocations", icon: "/img/arrow-right.svg"},
        ],
    },
    {
        title: 'Docs: Durable Timers',
