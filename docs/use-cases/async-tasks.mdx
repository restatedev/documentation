...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="python" label="Python">
        <Scrollycoding className="workflows-scroller-large">
            ...
            ```python ! async_task_service.py
            CODE_LOAD::python/src/use_cases/async_tasks/simple_async_task/task_submitter.py?4
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="python" label="Python">
        <Scrollycoding className={"workflows-scroller"}>
            ...
            CODE_LOAD::python/src/use_cases/async_tasks/fan_out_worker.py
            ```
...
<Tabs groupId="sdk" queryString>
    ...
    <TabItem value="python" label="Python">
        <Scrollycoding className={"workflows-scroller-large"}>
            ...
            ```py ! data_preparation_service.py
            CODE_LOAD::python/src/use_cases/async_tasks/sync_to_async/data_preparation_service.py?1
            ```
            ...
            ```python ! client.py
            CODE_LOAD::python/src/use_cases/async_tasks/sync_to_async/client.py?3
            ```
