...
<Scrollycoding>
    ...
    You can schedule tasks with the SDK clients or via HTTP.
    You can schedule the task for later via the optional delay parameter.
...
<SpotlightCard>
    <TwoColumnText features={[
        ...
        },
        {
            ...
            description: <>Restate makes sure all tasks run to completion. It keeps track of timers, handles retries and recovery upon failures, and ensures that tasks are executed exactly once. <br/><br/>  <a href={"https://restate.dev/what-is-durable-execution/"}>Learn more</a></>,
        },
    ]}/>
</SpotlightCard>
...
<Scrollycoding>
    ...
    Restate ensures sequential processing of events for the same key and gives you access to K/V state.
