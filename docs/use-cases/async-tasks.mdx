...
<Scrollycoding>
    ...
    ```java !!tabs Java
    CODE_LOAD::java/src/main/java/usecases/asynctasks/synctoasync/FileUploadWorkflow.java
    ```

    ```kotlin !!tabs Kotlin
    CODE_LOAD::kotlin/src/main/kotlin/usecases/asynctasks/synctoasync/FileUploadWorkflow.kt
    ```

    ```py !!tabs Python
    CODE_LOAD::python/src/use_cases/async_tasks/sync_to_async/file_upload_workflow.py?2
    ```
