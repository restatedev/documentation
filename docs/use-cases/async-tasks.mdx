...
<Scrollycoding>
    ...
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/queue/async_task_worker.py
    ...
    ```
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/queue/app.py
    ...
    CODE_LOAD::python/src/use_cases/async_tasks/simple_async_task/async_task_service.py
    ```
    ```python !!tabs Python https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/queue/client.py
