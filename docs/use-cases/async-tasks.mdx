...
<div className={"row"}>
    ...
    <div className={"col col--6"}>
        <img src={"/img/use_cases/use-case-async-tasks-light.svg"} alt={"Async tasks"}/>
    </div>
</div>
...
<ExampleWidget itemsPerRow={2} features={[
    ...
    },
    {
        ...
        links: [{url: "https://github.com/restatedev/examples/tree/main/patterns-use-cases/durable-promises/durable-promises-typescript", icon: "/img/typescript.svg"}]
    },
    {
