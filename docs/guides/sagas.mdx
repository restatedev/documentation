...
<Tabs groupId={"sdk"}>
    <TabItem value="typescript" label="TypeScript">
        ...
        <a className="btn btn-primary btn-lg githublink"
           href="https://github.com/restatedev/examples/blob/main/typescript/patterns-use-cases/src/sagas/booking_workflow.ts"
           target="_blank"
    ...
    <TabItem value="java" label="Java">
        ...
        ```
        <a className="btn btn-primary btn-lg githublink"
           href="https://github.com/restatedev/examples/blob/main/java/patterns-use-cases/src/main/java/my/example/sagas/BookingWorkflow.java"
           target="_blank"
           role="button"> To the sourcecode </a>
    </TabItem>
    <TabItem value="kotlin" label="Kotlin">
        ...
        ```
        <a className="btn btn-primary btn-lg githublink"
           href="https://github.com/restatedev/examples/blob/main/kotlin/patterns-use-cases/src/main/kotlin/my/example/sagas/BookingWorkflow.kt"
           target="_blank"
           role="button"> To the sourcecode </a>
    </TabItem>
    <TabItem value="python" label="Python">
        ...
        ```
        <a className="btn btn-primary btn-lg githublink"
           href="https://github.com/restatedev/examples/blob/main/python/patterns-use-cases/src/sagas/booking_workflow.py"
           target="_blank"
           role="button"> To the sourcecode </a>
    </TabItem>
    <TabItem value="go" label="Go">
        ...
        ```
        <a className="btn btn-primary btn-lg githublink"
           href="https://github.com/restatedev/examples/blob/main/go/patterns-use-cases/src/sagas/bookingworkflow.go"
           target="_blank"
           role="button"> To the sourcecode </a>
    </TabItem>
</Tabs>
