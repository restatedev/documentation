...
This guide helps you with fine-tuning the retry behavior for your use cases.
...
Transient errors are retried by default. This is done to make your system more resilient to temporary failures.

Restate lets you configure the retry strategy at different levels: at the Restate-level (global), at the service-level, and at the run-block-level.
