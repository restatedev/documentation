...
You can register deployments via the [UI](/develop/local_dev#restate-ui), via the CLI or via `curl` ([via the Restate Admin API](/references/admin-api#tag/deployment/operation/create_deployment)).
