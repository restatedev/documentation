...
- `sys_keyed_service_status` table to inspect keyed services (e.g. virtual objects) status
...
If you don't know the invocation id of your request, you can look it in the `sys_invocation` table as described [above](#listing-ongoing-invocations)
