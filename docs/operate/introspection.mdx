...
An exhaustive description of the schema can be found in [the references](/references/sql-introspection).
...
<Admonition type="info" title="`--binary` flag">
...
<Admonition type="info" title="`--plain` flag">
