...
Update `addTicket` to use `ctx.send` to send a one-way message to release the reservation:
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1b/ticket_service.ts#<start_reserve>-<end_reserve>
```
...
const addTicket = async (
  ...
  const reservationSuccess = await ctx.rpc(ticketServiceApi)
    .reserve(ticketId);
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/user_session.ts#<start_checkout>-<end_checkout>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/user_session.ts#<start_expire_ticket>-<end_expire_ticket>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/ticket_service.ts#<start_unreserve>-<end_unreserve>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/ticket_service.ts#<start_mark_as_sold>-<end_mark_as_sold>
```
...
Use a side effect in `Checkout/handle` to create and store a UUID (with the [uuid library](https://www.npmjs.com/package/uuid)) or idempotency key:
...
[restate] [2023-08-16T08:08:45.987Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Invoking function.
[restate] [2023-08-16T08:08:45.987Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:08:45.987Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:08:45.988Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-next-line
Payment call succeeded for idempotency key 923d1558-bf17-4c94-b027-4cfd778049fe and amount 40
[restate] [2023-08-16T08:08:45.988Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Journaled and sent output message ; OutputStreamEntryMessage
[restate] [2023-08-16T08:08:45.988Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Function completed successfully.
...
```log
// ... UserSessionService/Checkout logs ...
2023-12-08 19:18:10 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.Checkout/handle
2023-12-08 19:18:10 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.Checkout/handle
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part4/checkout.ts#<start_failing_client>-<end_failing_client>
```
