...
:::tip
Only public Restate services are callable from outside Restate using the ingress endpoint. [You can mark services as private](/operate/invocation#private-services) which makes them available only to other Restate services.
:::
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/checkout.ts#<start_checkout>-<end_checkout>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/app/user_session.ts#<start_user_session>-<end_user_session>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/user_session.ts#<start_user_session_api>-<end_user_session_api>
```
...
Have a look at the product service of the [shopping cart example](https://github.com/restatedev/examples/tree/main/end-to-end-applications/typescript/ecommerce-store).
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part1/UserSession.java#<start_expire_ticket>-<end_expire_ticket>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/user_session.ts#<start_add_ticket>-<end_add_ticket>
```
...
Then you call the `reserve` function, which returns a Promise that, in this case, gets resolved with the `boolean` response.
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part1/UserSession.java#<start_add_ticket>-<end_add_ticket>
```
...
Add the import:
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/ticket_service.ts#<start_import_sleep>-<end_import_sleep>
```

Add the sleep:
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/ticket_service.ts#<start_reserve>-<end_reserve>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part1/TicketService.java#<start_reserve>-<end_reserve>
```
...
[By default](/operate/configuration/#default-configuration), Restate will keep retrying failed invocations until they succeed. If at any point during testing you create an invocation that you want to permanently terminate, you can kill it using the [Admin API](https://docs.restate.dev/references/admin-api#tag/invocation) and the invocation id from the logs:
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/user_session.ts#<start_checkout_api_import>-<end_checkout_api_import>
```

Then call the `Checkout/handle` function:
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1/user_session.ts#<start_checkout>-<end_checkout>
```
...
[restate] [2023-08-15T21:06:12.676Z] DEBUG: [Checkout/handle] [H32MEMFENfUBiiHHQJxy5oLQ-W4akbii] : Invoking function.
[restate] [2023-08-15T21:06:12.677Z] DEBUG: [Checkout/handle] [H32MEMFENfUBiiHHQJxy5oLQ-W4akbii] : Journaled and sent output message ; OutputStreamEntryMessage
[restate] [2023-08-15T21:06:12.677Z] DEBUG: [Checkout/handle] [H32MEMFENfUBiiHHQJxy5oLQ-W4akbii] : Function completed successfully.
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part1/UserSession.java#<start_checkout>-<end_checkout>
```
...
2023-12-08 17:23:36 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.Checkout/handle
2023-12-08 17:23:36 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.Checkout/handle
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/ticket_service.ts#<start_reserve>-<end_reserve>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part2/TicketService.java#<start_reserve>-<end_reserve>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part2/user_session.ts#<start_add_ticket>-<end_add_ticket>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part2/UserSession.java#<start_add_ticket>-<end_add_ticket>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/user_session.ts#<start_add_ticket>-<end_add_ticket>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/UserSession.java#<start_add_ticket>-<end_add_ticket>
```
...
issue320_docs_injection_code_snippets
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/user_session.ts#<start_checkout>-<end_checkout>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/UserSession.java#<start_checkout>-<end_checkout>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/user_session.ts#<start_expire_ticket>-<end_expire_ticket>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/UserSession.java#<start_expire_ticket>-<end_expire_ticket>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/ticket_service.ts#<start_reserve>-<end_reserve>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/TicketService.java#<start_reserve>-<end_reserve>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/ticket_service.ts#<start_unreserve>-<end_unreserve>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/TicketService.java#<start_unreserve>-<end_unreserve>
```
</TabItem>
</Tabs>
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/ticket_service.ts#<start_mark_as_sold>-<end_mark_as_sold>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part3/TicketService.java#<start_mark_as_sold>-<end_mark_as_sold>
```
</TabItem>
</Tabs>
...
You can find a payment client stub in `auxiliary/PaymentClient`. Do the following:
    ...
    2.  Assume every ticket costs 40 dollars.
    3.  Then, use `call(idempotencyKey, amount)` to execute the payment for a certain idempotency key (String) and total amount (double/number).
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part4/checkout.ts#<start_side_effects>-<end_side_effects>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part4/Checkout.java#<start_side_effects>-<end_side_effects>
```
...
[restate] [2023-08-16T08:00:37.965Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Invoking function.
[restate] [2023-08-16T08:00:37.966Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:00:37.966Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:00:37.967Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Received completion message from Restate, adding to journal. ; CompletionMessage
//highlight-next-line
My idempotency key: dd92178a-85ca-4002-bfd5-0f3ed167317d
[restate] [2023-08-16T08:00:37.967Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Adding message to journal and sending to Restate ; SleepEntryMessage
[restate] [2023-08-16T08:00:37.967Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Scheduling suspension in 30000 ms
...
[restate] [2023-08-16T08:01:07.967Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Writing suspension message to journal. ; SuspensionMessage
[restate] [2023-08-16T08:01:07.967Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Suspending function.
//highlight-next-line
[restate] [2023-08-16T08:01:08.981Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Resuming (replaying) function.
[restate] [2023-08-16T08:01:08.983Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Matched and replayed message from journal ; undefined
//highlight-next-line
My idempotency key: dd92178a-85ca-4002-bfd5-0f3ed167317d
[restate] [2023-08-16T08:01:08.983Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Matched and replayed message from journal ; SleepEntryMessage
[restate] [2023-08-16T08:01:08.984Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Journaled and sent output message ; OutputStreamEntryMessage
[restate] [2023-08-16T08:01:08.984Z] DEBUG: [Checkout/handle] [f7_cNhBPYp4BiiHV5Zxwno4-FrEGNoOL] : Function completed successfully.
...
```log
... logs of `UserSession/checkout` ...
2023-12-08 18:52:51 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.Checkout/handle
2023-12-08 18:52:51 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.Checkout/handle
...
2023-12-08 18:53:52 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.Checkout/handle
2023-12-08 18:53:52 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.Checkout/handle
//highlight-next-line
...
:::info
Remove the throwing of the error, before you continue.
:::
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part4/checkout.ts#<start_checkout>-<end_checkout>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part4/Checkout.java#<start_checkout>-<end_checkout>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part4/user_session.ts#<start_checkout>-<end_checkout>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part4/UserSession.java#<start_checkout>-<end_checkout>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part5/checkout.ts#<start_failing_client>-<end_failing_client>
```
...
```java
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-java/src/main/java/dev/restate/tour/part5/Checkout.java#<start_failing_client>-<end_failing_client>
```
</TabItem>
</Tabs>
...
```log
[restate] [2023-08-16T08:24:28.507Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Invoking function.
[restate] [2023-08-16T08:24:28.507Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:24:28.507Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.508Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-next-line
Payment call failed for idempotency key adab6b35-0536-4348-8912-35f8cd474cf8 and amount 40. Retrying...
[restate] [2023-08-16T08:24:28.508Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:24:28.508Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.509Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-start
...
[restate] [2023-08-16T08:24:28.519Z] DEBUG: Error: Payment call failed
    ...
    at doPayment (/Users/till/restate/git/tour-of-restate-typescript/src/part5/checkout.ts:29:47)
    ...
    at checkout (/Users/till/restate/git/tour-of-restate-typescript/src/part5/checkout.ts:30:29)
...
[restate] [2023-08-16T08:24:28.520Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; SleepEntryMessage
// highlight-end
[restate] [2023-08-16T08:24:28.520Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.532Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-next-line
Payment call failed for idempotency key adab6b35-0536-4348-8912-35f8cd474cf8 and amount 40. Retrying...
[restate] [2023-08-16T08:24:28.532Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:24:28.532Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.532Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-start
...
[restate] [2023-08-16T08:24:28.534Z] DEBUG: Error: Payment call failed
    ...
    at executeWithRetries (/Users/till/restate/git/tour-of-restate-typescript/node_modules/@restatedev/restate-sdk/src/restate_context_impl.ts:428:20)
    at processTicksAndRejections (node:internal/process/task_queues:95:5)
    at checkout (/Users/till/restate/git/tour-of-restate-typescript/src/part5/checkout.ts:30:19)
    at dispatchUnkeyedRpcHandler (/Users/till/restate/git/tour-of-restate-typescript/node_modules/@restatedev/restate-sdk/src/server/base_restate_server.ts:366:18)
...
[restate] [2023-08-16T08:24:28.534Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; SleepEntryMessage
// highlight-end
[restate] [2023-08-16T08:24:28.534Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.556Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
// highlight-next-line
Payment call succeeded for idempotency key adab6b35-0536-4348-8912-35f8cd474cf8 and amount 40
[restate] [2023-08-16T08:24:28.557Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:24:28.557Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.557Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
Payment successful. Notifying user about shipment.
Notifying user 123 of payment success
[restate] [2023-08-16T08:24:28.557Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Adding message to journal and sending to Restate ; undefined
[restate] [2023-08-16T08:24:28.557Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Scheduling suspension in 30000 ms
[restate] [2023-08-16T08:24:28.558Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Received completion message from Restate, adding to journal. ; CompletionMessage
[restate] [2023-08-16T08:24:28.558Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Journaled and sent output message ; OutputStreamEntryMessage
[restate] [2023-08-16T08:24:28.558Z] DEBUG: [Checkout/handle] [bE19gwjrZxIBiiHKisNy5Jjvmc0fMHyk] : Function completed successfully.
```
...
```log
2023-12-08 19:19:19 [vert.x-eventloop-thread-0] DEBUG RequestHttpServerHandler:157 - Handling request to example.Checkout/handle
2023-12-08 19:19:19 [vert.x-eventloop-thread-0] DEBUG RestateGrpcServer:112 - Start processing call to example.Checkout/handle
...
java.lang.Error: Payment call failed
        ...
        at dev.restate.tour.part5.Checkout.lambda$checkout$1(Checkout.java:27) ~[main/:?]
        at dev.restate.sdk.RestateContextImpl.sideEffect(RestateContextImpl.java:143) ~[sdk-api-0.0.1-SNAPSHOT.jar:?]
        at dev.restate.tour.part5.Checkout.checkout(Checkout.java:27) ~[main/:?]
...
:::info 🚩 Have a look at the fully implemented app in `part5`, and run it with:
<Tabs groupId="sdk" queryString>
<TabItem value="ts" label="TypeScript">
