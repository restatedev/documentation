...
<TabItem value="python" label="Python">
    ...
    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part1/checkout_service.py#checkout
    ```
...
<Tabs groupId="sdk" queryString className={"display-none"}>
    ...
    <TabItem value="python" label="Python">
        ...
        CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part1/cart_object.py#add_ticket
        ```
...
<TabItem value="python" label="Python">
        ...
        ```python cart_object.py
        CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part1/cart_object.py#expire_ticket
        ```
...
<TabItem value="python" label="Python">
        ...
        <details>
            ...
            ```python cart_object.py
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part1/cart_object.py#checkout
            ```
...
```python cart_object.py
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part2/cart_object.py#add_ticket
```
...
```python cart_object.py
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/cart_object.py#add_ticket
```
...
<Tabs groupId="sdk" queryString className={"display-none"}>
    ...
    <TabItem value="python" label="Python">
        ...
        ```python cart_object.py
        CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/cart_object.py#checkout
        ```
...
<TabItem value="python" label="Python">
    ...
    <details>
        <summary>Solution</summary>
        ```python cart_object.py
        CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/cart_object.py#expire_ticket
        ```
...
<TabItem value="python" label="Python">
        <SubtleStep title="TicketObject/reserve" stepLabel="1">
            ...
            <details>
                ...
                CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/ticket_object.py#reserve
                ```
        ...
        <SubtleStep stepLabel="2" title="TicketObject/unreserve">
            ...
            <details>
                <summary>Solution</summary>
                ```python ticket_object.py
                CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/ticket_object.py#unreserve
                ```
        ...
        <SubtleStep stepLabel="3" title="TicketObject/markAsSold">
            ...
            <details>
                <summary>Solution</summary>
                ```python ticket_object.py
                CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part3/ticket_object.py#mark_as_sold
                ```
                In the next section, you implement the `CheckoutService/handle` function that calls `markAsSold`.
                This ties the final parts together.
            </details>
...
<TabItem value="python" label="Python">
    <SubtleStep stepLabel="1" title="Implement the email notifications">
        ...
        <details>
            <summary>Solution</summary>
            ```python checkout_service.py
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part4/checkout_service.py#checkout
            ```
        </details>
    </SubtleStep>
    <SubtleStep stepLabel="2" title="Mark tickets as sold">
        ...
        <details>
            <summary>Solution</summary>
            ```typescript cart_object.ts
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/main/tutorials/tour-of-restate-python/tour/part4/cart_object.py#checkout
            ```
        </details>
