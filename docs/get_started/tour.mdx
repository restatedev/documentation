...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part1b/user_session.ts#<start_add_ticket>-<end_add_ticket>
```
...
```typescript
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/checkout.ts#<start_side_effects>-<end_side_effects>
```
...
```ts
CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/issue320_docs_injection_code_snippets/tutorials/tour-of-restate-typescript/src/part3/checkout.ts#<start_checkout>-<end_checkout>
```
