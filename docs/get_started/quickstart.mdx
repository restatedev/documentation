...
<Step stepLabel="1" title="Get the Greeter service template">
    <div className="row">
        ...
        <div className="col col--6 quickstart">
            <VideoPlayer src="/img/quickstart/java_quickstart_part1.mp4" img="/img/quickstart/static_java_part1.png" />
        </div>
    </div>
</Step>
<Step stepLabel="2" title="Run the Greeter service">
    <div className="row">
        ...
        <div className="col col--6 quickstart">
            <VideoPlayer src="/img/quickstart/java_quickstart_part2.mp4" img="/img/quickstart/static_java_part2.png" />
        </div>
    </div>
</Step>
<Step stepLabel="3" title="Launch Restate">
    <div className="row">
        ...
        <div className="col col--6 quickstart">
            <VideoPlayer src="/img/quickstart/java_quickstart_part3.mp4" img="/img/quickstart/static_java_part3.png" />
        </div>
    </div>
</Step>
...
<Step stepLabel="4" title="Register the service">
    <div className="row">
        ...
        <div className="col col--6 quickstart">
            <VideoPlayer src="/img/quickstart/java_quickstart_part4.mp4" img="/img/quickstart/static_java_part4.png" />
        </div>
    </div>
...
<Step stepLabel="5" title="Send a request to the Greeter service">
    <div className="row">
        ...
        <div className="col col--6 quickstart">
            <VideoPlayer src="/img/quickstart/java_quickstart_part5.mp4" img="/img/quickstart/static_java_part5.png" />
        </div>
    </div>
</Step>
<Step end={true} stepLabel="🎉" title="Congratulations, you managed to run your first Restate service!"/>
...
<div className="row">
    ...
    <div className="col col--9 quickstart">
        <VideoPlayer src="/img/quickstart/java_recovery.mp4" />
    </div>
</div>
</details>
## Next steps
