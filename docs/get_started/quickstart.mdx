    ...
    steps={[
        {
          ...
          `,
            code: `npx -y @restatedev/create-app@latest && cd restate-node-template`
            },
            {
                label: 'Build and run the service',
                description: `
      ...
      `,
        ...
        {
            label: 'Send requests to the service',
            description: `
        Try out different ad text to see what brings in the most customers,
        and learn how to enhance your ads using features like ad extensions.
        If you run into any problems with your ads, find out how to tell if
...
[//]: # (            <StepContent>My step content story is a loooooong story that needs to appear here</StepContent>)
