...
<Tabs groupId="sdk" className={"display-none"}>
    <TabItem value="ts" label="TypeScript">
        ...
        <Step stepLabel="4" title="Register the service">
            ...
            You can do this via the UI (`http://localshot:9070`) or via:
    ...
    <TabItem value="python" label="Python">
        ...
        <Step stepLabel="5" title="Send a request to the Greeter service">
            ...
            <Terminal>
                ...
                ```shell !command
                curl localhost:8080/Greeter/greet -H 'content-type: application/json' -d '{"name": "Sarah"}'
                ```
