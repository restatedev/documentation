...
<Tabs groupId="sdk" queryString>
    <TabItem value="ts" label="TypeScript">
        ...
        <Step stepLabel="🎉" title="Congratulations, you just ran Durable Execution!">
            ...
            <Tabs groupId={"ts-runtime"} className={"display-none"}>
                <TabItem value={"Node.js"}>
                    ```ts
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/typescript/src/app.ts
                    ```
                </TabItem>
                <TabItem value={"Bun"}>
                    ```ts
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/bun/src/index.ts
                    ```
                </TabItem>
                <TabItem value={"Deno"}>
                    ```ts
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/deno/main.ts
                    ```
                </TabItem>
                <TabItem value={"CloudflareWorkers"} >
                    ```ts
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/cloudflare-worker/src/index.ts
                    ```
                </TabItem>
            </Tabs>
            ...
            Restate does this by persisting the progress of the handler.
            ...
            <Tabs groupId={"build-tool"} className={"display-none"}>
                <TabItem value={"maven"}>
                    <Tabs groupId={"architecture"} className={"display-none"}>
                        <TabItem value={"spring"}>
                            ```java
                            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/java-maven-spring-boot/src/main/java/com/example/restatestarter/Greeter.java
                            ```
                        </TabItem>
                        <TabItem value={"quarkus"}>
                            ```java
                            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/java-maven-quarkus/src/main/java/org/acme/Greeter.java
                            ```
                        </TabItem>
                        <TabItem value={"vanilla"}>
                            ```java
                            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/java-maven/src/main/java/my/example/Greeter.java
                            ```
                        </TabItem>
                    </Tabs>
                </TabItem>
                <TabItem value={"gradle"}>
                    <Tabs groupId={"architecture"} className={"display-none"}>
                        <TabItem value={"vanilla"}>
                            ```java
                            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/java-gradle/src/main/java/my/example/Greeter.java
                            ```
                        </TabItem>
                    </Tabs>
                </TabItem>
    ...
    <TabItem value="kotlin" label="Kotlin">
        ...
        <Step stepLabel="🎉" title="Congratulations, you just ran Durable Execution!">
            ...
            ```kotlin
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/kotlin-gradle/src/main/kotlin/my/example/Greeter.kt
            ```
    ...
    <TabItem value="go" label="Go">
        ...
        <Step stepLabel="🎉" title="Congratulations, you just ran Durable Execution!">
            ...
            ```go
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/go/greeter.go
            ```
    ...
    <TabItem value="python" label="Python">
        ...
        <Step stepLabel="🎉" title="Congratulations, you just ran Durable Execution!">
            ...
            ```python
            CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/python/example.py
            ```
    ...
    <TabItem value="rust" label="Rust">
        ...
        <Step stepLabel="🎉" title="Congratulations, you just ran Durable Execution!">
            ...
            <Tabs groupId={"rust-runtime"} className={"display-none"}>
                <TabItem value={"Tokio"}>
                    ```rust
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/rust/src/main.rs
                    ```
                </TabItem>
                <TabItem value={"Shuttle"}>
                    ```rust
                    CODE_LOAD::https://raw.githubusercontent.com/restatedev/examples/refs/heads/new_quickstart/templates/rust-shuttle/src/main.rs
                    ```
                </TabItem>
            </Tabs>
