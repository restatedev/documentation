...
<div className="row">
    <div className={"col col--6"}>
        ...
        ❌ **Loss of intermediate results**: If the handler would fail halfway, we would lose the payment identifier, unless we store it in a database and write the logic to recover it on retry.
        ...
        ❌ **No deduplication**: We could end up with multiple payments or subscriptions for the same user.
    ...
    <div className={"col col--6"}>
        ...
        ✅ **Built-in retries**: If the APIs  down or the network fails, Restate makes sure this gets retried until it succeeds.
        ...
        We also get **idempotency for requests** to this handler for free. By calling this handler with an idempotency key, Restate will ensure that the handler is only executed once for that key.
        Guarding against duplicate requests and concurrent retries.
...
Feel free to copy the Restate version into your template project and run it:
