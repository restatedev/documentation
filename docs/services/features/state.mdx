...
For the serialization of custom types, have a look at the [serialization documentation](/services/features/serialization).
...
Have a look at [the docs on retrieving state](/services/features/state#retrieving-state) to understand how to create the state key.
