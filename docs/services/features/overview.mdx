...
The [Restate context](/services/features/restate-context) enables interaction with Restate (call other methods, retrieve state, etc.).
...
For more information on how to set up the routers and the Restate server, have a look at the [serving docs](/services/features/serving).
...
The [Restate context](/services/features/restate-context) is supplied to the method as the first argument.
