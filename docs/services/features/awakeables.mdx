...
For other types, have a look at the [serialization documentation](/services/features/serialization).
...
You can also reject an awakeable, that is completing it with a failure. This will cause the waiting service to throw [a terminal error](/services/features/error-handling):
