...
- To use Java: `dev.restate.sdk:sdk-java-blocking:VAR::JAVA_SDK_VERSION`
- To use Kotlin: `dev.restate.sdk:sdk-kotlin:VAR::JAVA_SDK_VERSION`

Depending on the deployment target:
- To run as long-running app: `dev.restate.sdk:sdk-http-vertx:VAR::JAVA_SDK_VERSION`
- To run on AWS Lambda: `dev.restate.sdk:sdk-lambda:VAR::JAVA_SDK_VERSION`

To use Jackson to read/write state entries: `dev.restate.sdk:sdk-serde-jackson:VAR::JAVA_SDK_VERSION`
