...
:::tip
To get started, check out a template project of [the Java examples](https://github.com/restatedev/examples/tree/main/jvm).
:::
...
To use Jackson for serialization, add the following dependency: `dev.restate.sdk:sdk-serde-jackson:VAR::JAVA_SDK_VERSION`
