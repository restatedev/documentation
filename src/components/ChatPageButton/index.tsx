...
function getQuery(currentUrl){
    const query = `Read this page of the Restate documentation ${currentUrl}.md so I can ask questions about it.
        Guidelines:
        - To answer the question you might need to read the rest of the Restate Documentation https://docs.restate.dev/llms.txt
        and Restate Examples https://github.com/restatedev/examples 
        - Answer the questions using only the documentation and examples mentioned here. 
        ...
        Start by giving a brief summary of the page, then answer the question.
    `;
