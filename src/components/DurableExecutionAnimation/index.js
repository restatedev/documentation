    ...
    render() {
        return <div className="col col--7 padding-horiz--md">
            <p id="animation_explanation" className="padding--sm padding-left--md text--center">
                This animation shows you how durable execution takes place in Restate.
                The animation shows a ticket reservation platform for a theatre, where users can add tickets to their cart.
                Tickets can only be reserved by a single user.
                The application consists of two components: the CartService and the TicketService.
            </p>
            <div id="cart_service_div" className="row margin-vert--none margin-horiz--none">
                ...
                <div className="col col--11 padding-horiz--none bg-light section_animation smaller_font">
                    ...
                    <span className="hljs-keyword">async function</span> addTicket{"(ctx, order){"}
                            {"\n"}
                            {"  "}
                    ...
                    <span className="hljs-string">"cart"</span>);{"\n"}
                            {"    "}ctx.
                    <span className="hljs-title function_"s>set</span>(
    ...
    function animate() {
        ...
        switch (animationIndex) {
            case 0: {
                ...
                document.getElementById("animation_explanation").innerHTML = "An HTTP request arrives at Restate. The request specifies that Joe wants to add a ticket with seat2B to his cart.";
                document
            ...
            case 2: {
                ...
                document.getElementById("animation_explanation").innerHTML = "After persisting the request, Restate invokes the addTicket handler, as specified by the request. " +
                    "Restate sends over the journal which contains the request data. The addTicket handler is part of the `Cart` virtual object." +
                    "Virtual objects have access to K/V state, so Restate also attaches the K/V state of the virtual object to the request, here the current cart content of Joe. "
            ...
            case 4: {
                ...
                document.getElementById("animation_explanation").innerHTML = "When adding a ticket to a cart, we first need to check if the ticket has not been reserved by someone else. " +
                    "To do that the addTicket handler does a call to the reserve handler of the TicketService." +
            ...
            case 5: {
                ...
                document.getElementById("animation_explanation").innerHTML = "Restate creates a new journal for the reserve call and adds the request data to it." +
                    "In the meantime, the CartService has suspended. Restate lets handlers suspend whenever they are waiting for something that gets managed by Restate (e.g. RPC, timers, awakeables). " +
            ...
            case 6: {
                ...
                document.getElementById("animation_explanation").innerHTML = "Restate invokes the reserve handler of the TicketService and supplies the journal.";
            ...
            case 7: {
                ...
                document.getElementById("animation_explanation").innerHTML = "The function executes and eventually the ticket gets reserved successfully. " +
                    "The success result is logged in the journal of the TicketService, and this invocation is now considered completed. " +
                    "Restate will then proxy the response to the CartService.";
                highlightNextTicketSvcCodeLine();
                document
                    .getElementById("ticket_request_arrow")
                    .classList.add("display-none");
            ...
            case 8: {
                ...
                document.getElementById("animation_explanation").innerHTML = "Restate adds the success response to the journal of the addTicket handler. " +
            ...
            case 11: {
                ...
                document.getElementById("animation_explanation").innerHTML = "The handler adds the ticket to the state and stores it in Restate." +
                    ...
                    "Any subsequent calls to the CartService will see the updated state.";
                highlightNextCartSvcCodeLine()
                // Set the state
