...
>(({ className, ...props }, ref) => (
      <TabsPrimitive.List
        ref={ref}
        className={cn(styles.codetablist,
          "inline-flex h-8 items-center justify-start bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400 w-full",
          className,
        )}
        {...props}
      />
