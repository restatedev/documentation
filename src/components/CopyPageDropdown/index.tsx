// src/components/CopyPageDropdown.js
...
const AiIcon = <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
const AskAiButton = () => {
    ...
    const markdownUrl = `${window.location.origin}${currentUrl}.md`;
    const query = `Read from ${markdownUrl} so I can ask questions about it.`;
                    ...
                    <DropdownMenuItem onSelect={handleCopyMarkdown}>
                        <div>
                            ...
                            <div className={styles.child}>
                                ...
                                <br/>
                                <small>Copy as input for LLMs</small>
                            </div>
                        </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
